...
Page({
  ...
  onLoad: function (options) {
        ...
        wx.request({
          ...
          success: function(res){
            console.log(res)
           var s1=encodeURIComponent(res.data.ChapterContent,"UTF-8")
           var content=res.data.ChapterContent=that.reconvert(s1).slice(4);
           var content1 = that.parseLyric(content);
            // success
          },
          fail: function(res) {
            // fail

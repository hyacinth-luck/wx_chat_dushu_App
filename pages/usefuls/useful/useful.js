...
Page({
  data:{
    ...
    navImg:[
      {
        "imgUrl":"../../../images/yingshi.png",
        "imgTit":"影视同期"
      },{
        "imgUrl":"../../../images/ganhuo.png",
        "imgTit":"干货图书"
      },{
        "imgUrl":"../../../images/quanben.png",
        "imgTit":"全本图书"
      },{
        "imgUrl":"../../../images/chuban.png",
        "imgTit":"出版图书"
      }
    ]
  },
  popularBooksView:function(){
     wx.navigateTo({
    ...
    wx.request({
      ...
      success: function(res){
        ...
        that.setData({
          ...
          discoveryColumns:res.data.discoveryColumns,
